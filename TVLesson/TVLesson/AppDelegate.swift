...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    var window: UIWindow?
    var viewController:ImageFeedCollectionViewController? = nil
 ...
 /*
        self.viewController = self.window?.rootViewController as! ImageFeedCollectionViewController
